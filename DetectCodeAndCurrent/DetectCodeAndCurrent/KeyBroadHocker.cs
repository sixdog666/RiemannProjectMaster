...
namespace DetectCodeAndCurrent {
    public class ScanerHook {
        ...
        public ScanerHook() {
            waitDataThread = new Thread(StartGetData);
        }
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam) {
            ...
            codes.Add(msg);
            //if (waitDataThread.ThreadState == System.Threading.ThreadState.Unstarted) {
            //    waitDataThread.Start();

            //}
            //else {
            //    if (waitDataThread.ThreadState == System.Threading.ThreadState.Stopped) {
        ...
        private void StartGetData() {
            ...
            if (ScanerEvent != null && !string.IsNullOrEmpty(codes.Result)) {
                ScanerEvent(codes);
                startFlag = false;
            }
